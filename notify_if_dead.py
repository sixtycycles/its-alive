"""
You gotta change the numbers. This should run via cron/systemd every minute, set the "max_delay" value to the number of minutes it can be dead for before yelling about it. 
"""
